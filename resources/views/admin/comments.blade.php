                                    ...
                                    @foreach($comments as $key=>$comment)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <span class="badge bg-black">Unapproved</span>
                                                @endif
                                            </td>

                                            <td>
                                                <input type="checkbox" data-id="{{ $comment->id }}" name="status" class="js-switch" {{ $comment->status == 1 ? 'checked' : '' }}>
                                            </td>
        ...
        $(document).ready(function(){
            $('.js-switch').change(function () {
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: '',
                    data: {'status': status, 'id': commentId},
